...
public partial class Ajuste
{
    ...
    public decimal? Entradasexentasinternas { get; set; }

    public decimal? Entradasexentasimportaciones { get; set; }

    public decimal? Gravadasinternas { get; set; }

    public decimal? Gravadasimportaciones { get; set; }

    public decimal? Entradasaexcluidos { get; set; }

    public decimal? Entradasgravadas { get; set; }

    public decimal? Entradasexentas { get; set; }
    ...
    public decimal? Entradasgravadasimportaciones { get; set; }

    public decimal? Entradasgravadasinternas { get; set; }
